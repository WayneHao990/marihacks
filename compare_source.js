...
function comparePlayers() {
	...
	let player2Stats = players.find(player => player.name === player2);

    document.getElementById("player2Image").src = player1Stats.imgSrc
    document.getElementById("player1Image").src = player2Stats.imgSrc


	let resultTable = document.getElementById("resultTable");
	resultTable.rows[6].cells[1].innerHTML = player1Stats.goals;
	resultTable.rows[6].cells[2].innerHTML = player2Stats.goals;
	resultTable.rows[5].cells[1].innerHTML = player1Stats.assists;
	resultTable.rows[5].cells[2].innerHTML = player2Stats.assists;
    resultTable.rows[3].cells[1].innerHTML = player1Stats.position
    resultTable.rows[3].cells[2].innerHTML = player2Stats.position
    resultTable.rows[2].cells[1].innerHTML = player1Stats.age
    resultTable.rows[2].cells[2].innerHTML = player2Stats.age
    resultTable.rows[4].cells[1].innerHTML = player1Stats.matches
    resultTable.rows[4].cells[2].innerHTML = player2Stats.matches
    resultTable.rows[1].cells[1].innerHTML = player1Stats.nationality
    resultTable.rows[1].cells[2].innerHTML = player2Stats.nationality
    resultTable.rows[0].cells[1].innerHTML = player1Stats.name
    resultTable.rows[0].cells[2].innerHTML = player2Stats.name;
    resultTable.rows[7].cells[1].innerHTML = player1Stats.tackles
    resultTable.rows[7].cells[2].innerHTML = player2Stats.tackles;
    resultTable.rows[8].cells[1].innerHTML = player1Stats.saves
    resultTable.rows[8].cells[2].innerHTML = player2Stats.saves;
}
